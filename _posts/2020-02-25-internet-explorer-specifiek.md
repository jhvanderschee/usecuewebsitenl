...
Een grote kritiek op 'user agent sniffing' zoals deze techniek heet, is dat de techniek inaccurate resultaten geeft. Daar kan ik weinig anders tegenin brengen dan [de lijst van Trident browsers](https://en.wikipedia.org/wiki/Trident_(software)) bekijken en bedenken dat de schade wel mee zal vallen. Daarnaast is het onwaarschijnlijk dat er een nieuwe browser uitkomt met de Trident layout engine (waarop onze code mogelijk een averechts effect zou kunnen hebben). Internet Explorer is niet meer en Microsoft heeft zijn kaarten op Chromium gezet, dat de Blink engine gebruikt.